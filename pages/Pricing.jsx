...
const pricing = [
  {
    ...
    items: [
      ...
      { description: 'Tagesbetreuung 2 Spaziergängen à 30-45min', price: '55.-' },
  ...
  },
  {
    category: 'Betreuung',
    items: [
      { description: 'Welpenbetreuung 8-24 Wochen (Sozialverhalten und Grunderziehung) pro Tag', price: '65.-' },
